    ...
    for (int i = 0; i < ((dat[0].length)/5).round(); i++) {
      ...
      else if(i>0 && i!=((dat[0].length)/5).round()-1)
      {
        ...
        if ('${eta_lines[1]}'!=''
          ...
          rower.add(dat[0][5 * i + 1].toString());
          rower.add(dat[0][5 * i + 2].toString());
          rower.add(dat[0][5 * i + 3].toString());
          rower.add(dat[0][5 * i + 4].toString());
      ...
      else if(i>0 && i==((dat[0].length)/5).round()-1)
      {
            ...
            || dat[0][5*i + 4]!=null)
        {
          ...
          rower.add(dat[0][5 * i + 3].toString());
          rower.add(dat[0][5 * i + 4].toString());
          rower.add(dat[0][5 * i + 5].toString());
          rows.add(rower);
        }
